...
const Cat = () => {
  ...
  // useEffect(()=> {}, []) // -> empty depency array

  useEffect(()=>{
    if (localStorage.getItem('statusCode')){
      setStatusChange(localStorage.getItem('statusCode'))
    }
  }, [])
  
  // componentDidUpdate = a depedency array with any variable
  // this will run every time that variable changes
  // useEffect(()=> {}, [colorIdx]) // everytime colorIdx changes it'll rerender

  // componentWillUpdate = a simple useEffect
  // it'll always run on rerender
  // useEffect(()=>{})
